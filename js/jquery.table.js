/**
 * Jquery.table plugin
 * Version 2.4.2 - 08 February 2018
 * Copyright (c) 2018 by Feelinear:
 * 1、修复IE下表头文字无法显示的bug
 * 2、新增fixedXScroll、theme参数
 *
    ...
    SetJQueryTable.prototype = {
        ...
        renderXHeadTable: function () {
            ...
            $.each(self.xData, function (index, data) {
				if(data){
					...
					tdDom.find(".x_head_td_div").css("top", self.options.cssProperty.tdHeight/2);
        ...
        renderYHeadTable: function(){
            ...
            $.each(self.yData, function (index, data) {
				...
				trDom.find(".y_head_td_div").css("top", self.options.cssProperty.tdHeight/2);
